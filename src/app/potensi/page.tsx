...
import { getSemuaUmkm, getWhatsAppLink } from "@/lib/umkmStorage";
    ...
    <div className="py-12 space-y-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        ...
        <p className="text-base text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Dukung dan beli produk-produk khas Nagari Toboh Gadang hasil karya kelompok tani, pengrajin songket, dan pelaku usaha lokal. Hubungi langsung penjual via WhatsApp.
        </p>
      </section>

      {/* 1. GALERI UMKM UNGGULAN */}
            ...
            return (
              ...
              >
                ...
                {item.gambar ? (
                  ...
                  <div className={`h-44 bg-gradient-to-br ${item.gradient || "from-amber-800 to-amber-950"} p-5 flex flex-col justify-between text-white relative select-none overflow-hidden`}>
